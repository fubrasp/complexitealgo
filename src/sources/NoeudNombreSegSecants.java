...
/**
 * Classe modelisant un objet associant un nombre de segments et un nombre de paires de segments qui sont secants
...
public class NoeudNombreSegSecants {
	...
	/**
	 * Constructeur permetant de creer un objet associant un nombre n de segments,
	 * a un nombre de paires de segments secants
	 * @param nombreDeSegments nombre de segments
	 * @param nombreDePaireSecantes nombre de paires de segments secants
	 */
